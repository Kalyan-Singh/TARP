...
function CreateAGuide() {
  ...
  const api_key='052e442b8feb53e7d4e0';
  const api_secret_key='059bdfa7a67942f9462b8721617fc38ec5580d0601f5e7dfa72cafccd7261a28';
  ...
  async function uploadJSON() {
    ...
    const config = {
      headers: {
        "Content-Type": `multipart/form-data; boundary=${df._boundary}`,
