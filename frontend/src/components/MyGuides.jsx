...
function MyGuides() {
  ...
  //     //     } catch (e) {
  //     //       let item = {
  //     //         tokenId: "unknown (invalid uri)",
  //     //         creator: "unknown (invalid uri)",
  //     //         image:
  //     //           "/home/kalyan_singh/BUIDL2022/Moralis_full_stack/frontend/src/Images/101230258_p0_master1200.jpg",
  ...
  //     // const validItems = items.filter((item) => item.tokenId !== "unknown (invalid uri)");
      ...
      const items = await Promise.all(data.map(async (i) => {
        ...
        try {
          ...
          let item = {
            tokenId: "unknown (invalid uri)",
            creator: "unknown (invalid uri)",
            image: "/home/kalyan_singh/BUIDL2022/Moralis_full_stack/frontend/src/Images/101230258_p0_master1200.jpg",
            external_url: "unknown",
            description: "Unknown",
            name: "Unknown",
          };
